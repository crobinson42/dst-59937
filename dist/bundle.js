(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["DillonTaskMonkey"] = factory();
	else
		root["DillonTaskMonkey"] = factory();
})(this, function() {
...
var _Tagify = __webpack_require__(4);
...
var TagInput = function () {
	function TagInput(params) {
		...
		this.filter = function (e) {
			var values = _this.tagifiedEl.value;

			_this.params.$autocompleteElements.each(function (i, el) {
				var $el = $(el);
		...
		this.tagifiedEl = new _Tagify2.default(document.querySelector('[name="' + this.createTagName() + '"]'), _defineProperty({
	...
	_createClass(TagInput, [{
		key: 'createTagName',
		value: function createTagName() {
			return 'tags-' + this.params.name;
		}
	}, {
		key: 'createElement',
		value: function createElement() {
			var inputValues = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
   ...
   */
		...
		key: 'makeOptionsList',
		value: function makeOptionsList($elements) {
			if (!$elements) {
				return console.warn('makeOptionsList $elements is undefined');
			}

			var options = $elements.map(function (i, el) {
				return $(el).text().trim();
			}).toArray();

			options = options.filter(function (str) {
				return str && str.length;
			});

			// make a duplicate free array of texts
			options = _Util2.default.uniq(options);
...
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; // import our styles
...
function Tagify(input, settings) {
	...
	settings = (typeof settings === 'undefined' ? 'undefined' : _typeof(settings)) == 'object' ? settings : {}; // make sure settings is an 'object'
...
Tagify.prototype = {
	build: function build(input) {
		...
		if (this.settings.autocomplete && this.settings.whitelist.length) this.DOM.datalist = this.buildDataList();

		// if the original input already had any value (tags)
		if (value) this.addTag(value).forEach(function (tag) {
	...
	callbacks: {
		...
		onKeydown: function onKeydown(e) {
			...
			if (e.key == "Enter") {
				...
				if (this.addTag(s)) e.target.value = '';
				return false;
			} else {
  ...
  */
	...
	markTagByValue: function markTagByValue(value) {
	...
	addTag: function addTag(value) {
		...
		return value.split(',').filter(function (v) {
			...
			if (!tagAllowed) {
				...
				setTimeout(function () {
					that.removeTag(that.getNodeIndex(tagElm), true);
				}, 1000);

				// broadcast why the tag was not allowed
				if (maxTagsExceed) tagNotAllowedEventName = 'maxTagsExceed';else if (that.isTagBlacklisted(v)) tagNotAllowedEventName = 'blacklisted';else if (that.settings.enforeWhitelist && !that.isTagWhitelisted(v)) tagNotAllowedEventName = 'notWhitelisted';
  ...
  */
	removeTag: function removeTag(idx, silent) {
...
var _FilterInput = __webpack_require__(18);

var _FilterInput2 = _interopRequireDefault(_FilterInput);

var _TagInput = __webpack_require__(2);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./Tagify.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./Tagify.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./styleOverRide.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./styleOverRide.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, "/* this allows the tagify input not to stretch out the row width */\n.category, .priority, .status, .due, .release, .assignedTo, .clientTicket {\n    white-space: normal;\n}", ""]);
...
var FilterInput = function () {
	function FilterInput(params) {
		...
		this.filter = function () {
			var values = _this.$el.val();

			var matches = function matches(val1, val2) {
				return val1;
			};

			_this.params.$filterElements.each(function (i, el) {
				var $el = $(el);
...
// module
exports.push([module.i, "div.filterInput {\n    padding: 7px;\n    border: 1px solid #DDD;\n}\n\ndiv.filterInput input {\n    border: none;\n}", ""]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./FilterInput.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./FilterInput.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
